...
public class HomeworkFragmentListItem {
    ...
    HomeworkFragmentListItem(String character_image, String character_nickname, String character_level, String character_class, String character_itemLevel, String character_server) {
        this.character_image = character_image;
        this.character_nickname = character_nickname;
        this.character_level = character_level;
        this.character_class = character_class;
